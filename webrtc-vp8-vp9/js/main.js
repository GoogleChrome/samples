...
/* globals $ mediaGroupSetup Mousetrap URI */

var uri = new URI(location.href);

var videos = [
{sample: 'vp8_vs_vp9_1',
vp8Path: 'videos/out1.vp8.off.900.25.1280_720.webm',
vp8Bitrate: '900 kbs',
vp9Path: 'videos/out1.vp9.650.25.1280_720_0.webm',
vp9Bitrate: '650 kbs'},
{sample: 'vp8_vs_vp9_2',
vp8Path: 'videos/out2.vp8.off.900.25.1280_720.webm',
vp8Bitrate: '900 kbs',
vp9Path: 'videos/out2.vp9.650.25.1280_720_0.webm',
vp9Bitrate: '650 kbs'
},
{sample: 'vp8_vs_vp9_3',
vp8Path: 'videos/out3.vp8.off.900.25.1280_720.webm',
vp8Bitrate: '900 kbs',
vp9Path: 'videos/out3.vp9.650.25.1280_720_0.webm',
vp9Bitrate: '650 kbs'
},
{sample: 'vp8_vs_vp9_4',
vp8Path: 'videos/out4.vp8.off.900.25_1280_720.webm',
vp8Bitrate: '900 kbs',
vp9Path: 'videos/out4.vp9.650.25.1280_720_0.webm',
vp9Bitrate: '650 kbs'
}
];
...
$(selectA).change(function() {
  ...
  loadLeftMedia(videos[selected].vp8Path);
  loadRightMedia(videos[selected].vp9Path);
  leftVid.load();
  rightVid.load();
});
...
Mousetrap.bind('1', function() {
  $('#viewNav a[data-css="css/splitview.css"]').tab('show');
});
Mousetrap.bind('2', function() {
  $('#viewNav a[data-css="css/vertview.css"]').tab('show');
});
Mousetrap.bind('3', function() {
  $('#viewNav a[data-css="css/horizview.css"]').tab('show');
});
Mousetrap.bind('4', function() {
  $('#viewNav a[data-css="css/leftview.css"]').tab('show');
});
Mousetrap.bind('5', function() {
  $('#viewNav a[data-css="css/rightview.css"]').tab('show');
});
...
if (params.left) {
  ...
  loadLeftMedia(videos[0].vp8Path);
}
if (params.right) {
  loadRightMedia(params.right);
} else {
  loadRightMedia(videos[0].vp9Path);
}
