...
function respondToShare(event) {
  event.respondWith((async () => {
    ...
    let body = page.replace('{{received_title}}', escapeQuotes(receivedTitle)).replace('{{received_text}}', escapeQuotes(receivedText)).replace('{{received_url}}', escapeQuotes(receivedUrl));
