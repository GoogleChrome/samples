import { b4 as u, l as b, b5 as l, b6 as x, au as A, d as p, b7 as w, b8 as D, b9 as y, aR as F, aQ as z, ba as Q, t as N, bb as X, ad as vt, q, o as R, a1 as mt, C as g, bc as ee, bd as ne, be as te, bf as re, bg as ie, D as d, m as C, aI as se, bh as oe, aJ as ae, bi as ue, y as j, F as a, z as U, f as m, H as K, bj as _e, bk as le, bl as ce } from "./common-63fc3a52.rn.js";

export { bm as _internalPipelineToExecutePipelineRequestProto } from "./common-63fc3a52.rn.js";
 ...
 */ function __PRIVATE_vectorToExpr$1(e) {
    ...
    if (e instanceof F) return constant(e);
    if (Array.isArray(e)) return constant(z(e));
 ...
 */ class Expression {
    ...
    timestampTruncate(e, n) {
        const t = [ this, __PRIVATE_valueToDefaultExpr$1(l(e) ? e.toLowerCase() : e) ];
...
function _field(e, n) {
    return new Field("string" == typeof e ? x === e ? A()._internalPath : p("field", e) : e._internalPath, n);
}
 ...
 */ class Constant extends Expression {
     ...
     * @internal
     */    _toProto(e) {
        return w(void 0 !== this._protoValue, 237), this._protoValue;
    }
    /**
     * @private
     * @internal
     */    _readUserData(e) {
        e = this._methodName ? e.i({
            methodName: this._methodName
        }) : e, __PRIVATE_isFirestoreValue(this._protoValue) || (this._protoValue = D(this.value, e));
    }
}
...
function timestampTruncate(e, n, t) {
    const r = l(n) ? __PRIVATE_valueToDefaultExpr$1(n.toLowerCase()) : n;
...
function __PRIVATE_isSelectable(e) {
    const n = e;
    return n.selectable && l(n.alias) && __PRIVATE_isExpr(n.expr);
}
...
function __PRIVATE_isAliasedAggregate(e) {
    const n = e;
    return l(n.alias) && n.aggregate instanceof AggregateFunction;
}
...
function __PRIVATE_toPipeline(e, n) {
    let t;
    t = N(e) ? n.pipeline().collectionGroup(e.collectionGroup) : X(e) ? n.pipeline().documents([ vt(n, e.path.canonicalString()) ]) : n.pipeline().collection(e.path.canonicalString());
    // filters
        for (const n of e.filters) t = t.where(__PRIVATE_toPipelineBooleanExpr(n));
    // orders
        const r = q(e), i = e.explicitOrderBy.map((e => field(e.field.canonicalString()).exists()));
    if (i.length > 0) {
 ...
 */ class __PRIVATE_Aggregate extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ Q(e, this.accumulators), Q(e, this.groups) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_FindNearest extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.field._toProto(e), this.vectorValue._toProto(e), y(this.distanceMeasure) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_Limit extends Stage {
    ...
    constructor(e, n) {
        w(!isNaN(e) && e !== 1 / 0 && e !== -1 / 0, 34860), super(n), this.limit = e;
    }
    /**
     * @internal
     * @private
 ...
 */ class __PRIVATE_Sample extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ ne(e, this.rate), y(this.mode) ]
        };
    }
    _readUserData(e) {
        super._readUserData(e);
 ...
 */ class __PRIVATE_Replace extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.map._toProto(e), y(__PRIVATE_Replace.T) ]
        };
    }
    _readUserData(e) {
 ...
 */ function __PRIVATE_readUserDataHelper(e, n) {
    return re(e) ? e._readUserData(n) : Array.isArray(e) ? e.forEach((e => e._readUserData(n))) : e.forEach((e => e._readUserData(n))), 
    e;
}
 ...
 */ class PipelineSource {
    ...
    documents(e) {
        ...
        // Convert user land convenience types to internal types
        const r = t.map((e => l(e) ? e : e.path)), i = new __PRIVATE_DocumentsSource(r, n);
        // Create stage object
                // Add stage to the pipeline
        return this._createPipeline([ i ]);
    }
    ...
    _validateReference(e) {
        ...
        if (!n.isEqual(this.databaseId)) throw new b(C.INVALID_ARGUMENT, `Invalid ${e instanceof se ? "CollectionReference" : "DocumentReference"}. The project ID ("${n.projectId}") or the database ("${n.database}") does not match the project ID ("${this.databaseId.projectId}") and database ("${this.databaseId.database}") of the target database of this Pipeline.`);
    }
}
 ...
 */ function pipelineResultEqual(e, n) {
    return e === n || oe(e._ref, n._ref, ae) && oe(e._fields, n._fields, ((e, n) => e.isEqual(n)));
}
 ...
 */ function __PRIVATE_selectablesToMap(e) {
    ...
    for (const t of e) {
        ...
        r = t.expr) : mt(21273, {
            selectable: t
        }), void 0 !== n.get(e)) throw new b("invalid-argument", `Duplicate alias or field '${e}'`);
        n.set(e, r);
    }
    return n;
}
 ...
 */
    return function __PRIVATE_valueToDefaultExpr(e) {
        ...
        if (e instanceof Expression) return e;
        n = u(e) ? map(e) : e instanceof Array ? array(e) : __PRIVATE__constant(e, void 0);
        return n;
    }
    /**
 * @license
...
class Pipeline$1 {
    ...
    removeFields(e, ...n) {
        // Process argument union(s) from method overloads
        const t = __PRIVATE_isField(e) || l(e) ? {} : e, r = (__PRIVATE_isField(e) || l(e) ? [ e, ...n ] : e.fields).map((e => l(e) ? field(e) : e)), i = new __PRIVATE_RemoveFields(r, t);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    select(e, ...n) {
        // Process argument union(s) from method overloads
        const t = __PRIVATE_isSelectable(e) || l(e) ? {} : e, r = __PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || l(e) ? [ e, ...n ] : e.selections), i = new __PRIVATE_Select(r, t);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    where(e) {
    ...
    limit(e) {
        // Process argument union(s) from method overloads
        const n = ue(e) ? {} : e, t = ue(e) ? e : e.limit, r = new __PRIVATE_Limit(t, n);
        // Add stage to the pipeline
        return this._addStage(r);
    }
    distinct(e, ...n) {
        // Process argument union(s) from method overloads
        const t = l(e) || __PRIVATE_isSelectable(e) ? {} : e, r = __PRIVATE_selectablesToMap(l(e) || __PRIVATE_isSelectable(e) ? [ e, ...n ] : e.groups), i = new __PRIVATE_Distinct(r, t);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    aggregate(e, ...n) {
 ...
 */ (r), o = __PRIVATE_selectablesToMap(i), a = new __PRIVATE_Aggregate(o, s, t);
    ...
    replaceWith(e) {
        // Process argument union(s) from method overloads
        const n = l(e) || __PRIVATE_isExpr(e) ? {} : e, t = __PRIVATE_fieldOrExpression(l(e) || __PRIVATE_isExpr(e) ? e : e.map), r = new __PRIVATE_Replace(t, n);
        // Add stage to the pipeline
        return this._addStage(r);
    }
    sample(e) {
        ...
        const n = ue(e) ? {} : e;
        let t, r;
        ue(e) ? (t = e, r = "documents") : ue(e.documents) ? (t = e.documents, r = "documents") : (t = e.percentage, 
        r = "percent");
        // Create stage object
 ...
 */ (e) ? ({other: t, ...n} = e) : (n = {}, t = e);
    ...
    unnest(e, n) {
        ...
        l(i) && (t.indexField = _field(i, "unnest"));
        // Create stage object
 ...
 */ function execute(e) {
    const n = e instanceof Pipeline$1 ? {
        pipeline: e
    } : e, {pipeline: t, rawOptions: r, ...i} = n, s = j(t._db, a), o = U(s), u = m(s).A(3 /* UserDataSource.Argument */ , "execute");
    t._readUserData(u);
    const _ = new K(s), l = new _e(i, r);
    l._readUserData(u);
    const c = new le(t, l);
    return ce(o, c).then((e => {
        ...
        const n = e.length > 0 ? e[0].executionTime?.toTimestamp() : void 0, r = e.filter((e => !!e.fields)).map((e => new PipelineResult(_, e.fields, e.key?.path ? new d(s, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp())));
