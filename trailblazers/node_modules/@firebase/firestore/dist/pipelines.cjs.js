...
/* eslint @typescript-eslint/no-explicit-any: 0 */ function __PRIVATE_isFirestoreValue(e) {
    return "object" == typeof e && null !== e && !!("nullValue" in e && (null === e.nullValue || "NULL_VALUE" === e.nullValue) || "booleanValue" in e && (null === e.booleanValue || "boolean" == typeof e.booleanValue) || "integerValue" in e && (null === e.integerValue || "number" == typeof e.integerValue || "string" == typeof e.integerValue) || "doubleValue" in e && (null === e.doubleValue || "number" == typeof e.doubleValue) || "timestampValue" in e && (null === e.timestampValue || function __PRIVATE_isITimestamp(e) {
        ...
        return "object" == typeof e && null !== e && !(!("fields" in e) || null !== e.fields && !common.__PRIVATE_isPlainObject(e.fields));
 ...
 */ function __PRIVATE_valueToDefaultExpr$1(e) {
    let n;
    return e instanceof Expression ? e : (n = common.__PRIVATE_isPlainObject(e) ? __PRIVATE__map(e) : e instanceof Array ? array(e) : __PRIVATE__constant(e, void 0), 
    n);
}
 ...
 */ function __PRIVATE_vectorToExpr$1(e) {
    ...
    if (e instanceof common.VectorValue) return constant(e);
    if (Array.isArray(e)) return constant(common.vector(e));
 ...
 */ function __PRIVATE_fieldOrExpression$1(e) {
    if (common.__PRIVATE_isString(e)) {
        return field(e);
    }
 ...
 */ class Expression {
     ...
     */    asBoolean() {
        ...
        throw new common.FirestoreError("invalid-argument", `Conversion of type ${typeof this} to BooleanExpression not supported.`);
    }
    subtract(e) {
    ...
    timestampTruncate(e, n) {
        const t = [ this, __PRIVATE_valueToDefaultExpr$1(common.__PRIVATE_isString(e) ? e.toLowerCase() : e) ];
...
function _field(e, n) {
    return new Field("string" == typeof e ? common.F === e ? common.documentId()._internalPath : common.__PRIVATE_fieldPathFromArgument("field", e) : e._internalPath, n);
}
 ...
 */ class Constant extends Expression {
     ...
     * @internal
     */    _toProto(e) {
        return common.__PRIVATE_hardAssert(void 0 !== this._protoValue, 237), this._protoValue;
    }
    /**
     * @private
     * @internal
     */    _readUserData(e) {
        e = this._methodName ? e.i({
            methodName: this._methodName
        }) : e, __PRIVATE_isFirestoreValue(this._protoValue) || (this._protoValue = common.__PRIVATE_parseData(this.value, e));
    }
}
 ...
 */ class MapValue extends Expression {
    ...
    _toProto(e) {
        return common.__PRIVATE_toMapValue(e, this._);
    }
}
...
function timestampTruncate(e, n, t) {
    const r = common.__PRIVATE_isString(n) ? __PRIVATE_valueToDefaultExpr$1(n.toLowerCase()) : n;
 ...
 */ class Ordering {
     ...
     */    _toProto(e) {
        return {
            mapValue: {
                fields: {
                    direction: common.__PRIVATE_toStringValue(this.direction),
...
function __PRIVATE_isSelectable(e) {
    const n = e;
    return n.selectable && common.__PRIVATE_isString(n.alias) && __PRIVATE_isExpr(n.expr);
}
...
function __PRIVATE_isAliasedAggregate(e) {
    const n = e;
    return common.__PRIVATE_isString(n.alias) && n.aggregate instanceof AggregateFunction;
}
...
/* eslint @typescript-eslint/no-explicit-any: 0 */ function __PRIVATE_toPipelineBooleanExpr(e) {
    if (e instanceof common.FieldFilter) {
    ...
    } else if (e instanceof common.CompositeFilter) switch (e.op) {
...
function __PRIVATE_toPipeline(e, n) {
    let t;
    t = common.__PRIVATE_isCollectionGroupQuery(e) ? n.pipeline().collectionGroup(e.collectionGroup) : common.__PRIVATE_isDocumentQuery$1(e) ? n.pipeline().documents([ common.doc(n, e.path.canonicalString()) ]) : n.pipeline().collection(e.path.canonicalString());
    // filters
        for (const n of e.filters) t = t.where(__PRIVATE_toPipelineBooleanExpr(n));
    // orders
        const r = common.__PRIVATE_queryNormalizedOrderBy(e), i = e.explicitOrderBy.map((e => field(e.field.canonicalString()).exists()));
    if (i.length > 0) {
 ...
 */ class __PRIVATE_AddFields extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common.__PRIVATE_toMapValue(e, this.fields) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_Aggregate extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common.__PRIVATE_toMapValue(e, this.accumulators), common.__PRIVATE_toMapValue(e, this.groups) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_Distinct extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common.__PRIVATE_toMapValue(e, this.groups) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_DocumentsSource extends Stage {
    ...
    constructor(e, n) {
        super(n), this.p = e.map((e => e.startsWith("/") ? e : "/" + e));
    }
    /**
     * @internal
     * @private
 ...
 */ class __PRIVATE_FindNearest extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.field._toProto(e), this.vectorValue._toProto(e), common.__PRIVATE_toStringValue(this.distanceMeasure) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_Limit extends Stage {
    ...
    constructor(e, n) {
        common.__PRIVATE_hardAssert(!isNaN(e) && e !== 1 / 0 && e !== -1 / 0, 34860), super(n), this.limit = e;
    }
    /**
     * @internal
     * @private
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common.toNumber(e, this.limit) ]
        };
    }
}
 ...
 */ class __PRIVATE_Offset extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common.toNumber(e, this.offset) ]
        };
    }
}
 ...
 */ class __PRIVATE_Select extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common.__PRIVATE_toMapValue(e, this.selections) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_Sample extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common.toNumber(e, this.rate), common.__PRIVATE_toStringValue(this.mode) ]
        };
    }
    _readUserData(e) {
        super._readUserData(e);
 ...
 */ class __PRIVATE_Union extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ common.__PRIVATE_toPipelineValue(this.other._toProto(e)) ]
        };
    }
    _readUserData(e) {
        super._readUserData(e);
 ...
 */ class __PRIVATE_Replace extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.map._toProto(e), common.__PRIVATE_toStringValue(__PRIVATE_Replace.T) ]
        };
    }
    _readUserData(e) {
 ...
 */ function __PRIVATE_readUserDataHelper(e, n) {
    return common.__PRIVATE_isUserData(e) ? e._readUserData(n) : Array.isArray(e) ? e.forEach((e => e._readUserData(n))) : e.forEach((e => e._readUserData(n))), 
    e;
}
 ...
 */ class PipelineSource {
    ...
    collection(e) {
        ...
        const n = common.__PRIVATE_isString(e) || common.__PRIVATE_isCollectionReference(e) ? {} : e, t = common.__PRIVATE_isString(e) || common.__PRIVATE_isCollectionReference(e) ? e : e.collection;
        // Validate that a user provided reference is for the same Firestore DB
        common.__PRIVATE_isCollectionReference(t) && this._validateReference(t);
        // Convert user land convenience types to internal types
                const r = common.__PRIVATE_isString(t) ? t : t.path, i = new __PRIVATE_CollectionSource(r, n);
        // Create stage object
    ...
    collectionGroup(e) {
        // Process argument union(s) from method overloads
        let n, t;
        common.__PRIVATE_isString(e) ? (n = e, t = {}) : ({collectionId: n, ...t} = e);
        // Create stage object
    ...
    documents(e) {
        ...
        t.filter((e => e instanceof common.DocumentReference)).forEach((e => this._validateReference(e)));
        // Convert user land convenience types to internal types
        const r = t.map((e => common.__PRIVATE_isString(e) ? e : e.path)), i = new __PRIVATE_DocumentsSource(r, n);
        // Create stage object
                // Add stage to the pipeline
        return this._createPipeline([ i ]);
    }
    ...
    _validateReference(e) {
        ...
        if (!n.isEqual(this.databaseId)) throw new common.FirestoreError(common.D.INVALID_ARGUMENT, `Invalid ${e instanceof common.CollectionReference ? "CollectionReference" : "DocumentReference"}. The project ID ("${n.projectId}") or the database ("${n.database}") does not match the project ID ("${this.databaseId.projectId}") and database ("${this.databaseId.database}") of the target database of this Pipeline.`);
    }
}
 ...
 */ class PipelineResult {
    ...
    get(e) {
        ...
        const n = this._fields.field(common.__PRIVATE_fieldPathFromArgument("DocumentSnapshot.get", e));
 ...
 */ function pipelineResultEqual(e, n) {
    return e === n || common.__PRIVATE_isOptionalEqual(e._ref, n._ref, common.refEqual) && common.__PRIVATE_isOptionalEqual(e._fields, n._fields, ((e, n) => e.isEqual(n)));
}
 ...
 */ function __PRIVATE_selectablesToMap(e) {
    ...
    for (const t of e) {
        ...
        r = t.expr) : common.fail(21273, {
            selectable: t
        }), void 0 !== n.get(e)) throw new common.FirestoreError("invalid-argument", `Duplicate alias or field '${e}'`);
        n.set(e, r);
    }
    return n;
}
 ...
 */
    return function __PRIVATE_valueToDefaultExpr(e) {
        ...
        if (e instanceof Expression) return e;
        n = common.__PRIVATE_isPlainObject(e) ? map(e) : e instanceof Array ? array(e) : __PRIVATE__constant(e, void 0);
        return n;
    }
    /**
 * @license
...
class Pipeline$1 {
    ...
    removeFields(e, ...n) {
        // Process argument union(s) from method overloads
        const t = __PRIVATE_isField(e) || common.__PRIVATE_isString(e) ? {} : e, r = (__PRIVATE_isField(e) || common.__PRIVATE_isString(e) ? [ e, ...n ] : e.fields).map((e => common.__PRIVATE_isString(e) ? field(e) : e)), i = new __PRIVATE_RemoveFields(r, t);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    select(e, ...n) {
        // Process argument union(s) from method overloads
        const t = __PRIVATE_isSelectable(e) || common.__PRIVATE_isString(e) ? {} : e, r = __PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || common.__PRIVATE_isString(e) ? [ e, ...n ] : e.selections), i = new __PRIVATE_Select(r, t);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    where(e) {
    ...
    offset(e) {
        // Process argument union(s) from method overloads
        let n, t;
        common.__PRIVATE_isNumber$1(e) ? (n = {}, t = e) : (n = e, t = e.offset);
        // Create stage object
    ...
    limit(e) {
        // Process argument union(s) from method overloads
        const n = common.__PRIVATE_isNumber$1(e) ? {} : e, t = common.__PRIVATE_isNumber$1(e) ? e : e.limit, r = new __PRIVATE_Limit(t, n);
        // Add stage to the pipeline
        return this._addStage(r);
    }
    distinct(e, ...n) {
        // Process argument union(s) from method overloads
        const t = common.__PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? {} : e, r = __PRIVATE_selectablesToMap(common.__PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? [ e, ...n ] : e.groups), i = new __PRIVATE_Distinct(r, t);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    aggregate(e, ...n) {
        ...
        const t = __PRIVATE_isAliasedAggregate(e) ? {} : e, r = __PRIVATE_isAliasedAggregate(e) ? [ e, ...n ] : e.accumulators, i = __PRIVATE_isAliasedAggregate(e) ? [] : e.groups ?? [], s = function __PRIVATE_aliasedAggregateToMap(e) {
            return e.reduce(((e, n) => {
                if (void 0 !== e.get(n.alias)) throw new common.FirestoreError("invalid-argument", `Duplicate alias or field '${n.alias}'`);
 ...
 */ (r), o = __PRIVATE_selectablesToMap(i), a = new __PRIVATE_Aggregate(o, s, t);
    ...
    replaceWith(e) {
        // Process argument union(s) from method overloads
        const n = common.__PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? {} : e, t = __PRIVATE_fieldOrExpression(common.__PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? e : e.map), r = new __PRIVATE_Replace(t, n);
        // Add stage to the pipeline
        return this._addStage(r);
    }
    sample(e) {
        // Process argument union(s) from method overloads
        const n = common.__PRIVATE_isNumber$1(e) ? {} : e;
        let t, r;
        common.__PRIVATE_isNumber$1(e) ? (t = e, r = "documents") : common.__PRIVATE_isNumber$1(e.documents) ? (t = e.documents, r = "documents") : (t = e.percentage, 
        r = "percent");
        // Create stage object
 ...
 */ (e) ? ({other: t, ...n} = e) : (n = {}, t = e);
    ...
    unnest(e, n) {
        ...
        common.__PRIVATE_isString(i) && (t.indexField = _field(i, "unnest"));
        // Create stage object
     ...
     */    rawStage(e, n, t) {
        // Convert user land convenience types to internal types
        const r = n.map((e => e instanceof Expression || e instanceof AggregateFunction ? e : common.__PRIVATE_isPlainObject(e) ? function __PRIVATE__mapValue(e) {
            const n = new Map;
        ...
        }(e) : __PRIVATE__constant(e, "rawStage"))), i = new __PRIVATE_RawStage(e, r, t ?? {});
        // Create stage object
                // Add stage to the pipeline
        return this._addStage(i);
    }
 ...
 */ function execute(e) {
    const n = e instanceof Pipeline$1 ? {
        pipeline: e
    } : e, {pipeline: t, rawOptions: r, ...i} = n, s = common.__PRIVATE_cast(t._db, common.Firestore), o = common.ensureFirestoreConfigured(s), u = common.__PRIVATE_newUserDataReader(s).A(3 /* UserDataSource.Argument */ , "execute");
    t._readUserData(u);
    const _ = new common.__PRIVATE_ExpUserDataWriter(s), l = new common.__PRIVATE_StructuredPipelineOptions(i, r);
    l._readUserData(u);
    const c = new common.StructuredPipeline(t, l);
    return common.__PRIVATE_firestoreClientExecutePipeline(o, c).then((e => {
        // Get the execution time from the first result.
        // firestoreClientExecutePipeline returns at least one PipelineStreamElement
        // even if the returned document set is empty.
        const n = e.length > 0 ? e[0].executionTime?.toTimestamp() : void 0, r = e.filter((e => !!e.fields)).map((e => new PipelineResult(_, e.fields, e.key?.path ? new common.DocumentReference(s, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp())));
