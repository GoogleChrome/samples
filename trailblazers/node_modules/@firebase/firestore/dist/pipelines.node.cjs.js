...
function isIMapValue(obj) {
    ...
    if ('fields' in obj && (obj.fields === null || commonE122c13e_node.isPlainObject(obj.fields))) {
        return true;
    }
    return false;
}
...
function valueToDefaultExpr$1(value) {
    ...
    else if (commonE122c13e_node.isPlainObject(value)) {
        result = _map(value);
    }
...
function vectorToExpr$1(value) {
    ...
    else if (value instanceof commonE122c13e_node.VectorValue) {
        return constant(value);
    }
    else if (Array.isArray(value)) {
        return constant(commonE122c13e_node.vector(value));
    }
    else {
...
function fieldOrExpression$1(value) {
    if (commonE122c13e_node.isString(value)) {
...
class Expression {
    ...
    asBoolean() {
        if (this instanceof BooleanExpression) {
            ...
            throw new commonE122c13e_node.FirestoreError('invalid-argument', `Conversion of type ${typeof this} to BooleanExpression not supported.`);
        }
    }
    subtract(subtrahend) {
    ...
    timestampTruncate(granularity, timezone) {
        const internalGranularity = commonE122c13e_node.isString(granularity)
...
function _field(nameOrPath, methodName) {
    if (typeof nameOrPath === 'string') {
        if (commonE122c13e_node.DOCUMENT_KEY_NAME === nameOrPath) {
            return new Field(commonE122c13e_node.documentId()._internalPath, methodName);
        }
        return new Field(commonE122c13e_node.fieldPathFromArgument('field', nameOrPath), methodName);
    }
    else {
...
class Constant extends Expression {
     ...
     */
    _toProto(_) {
        commonE122c13e_node.hardAssert(this._protoValue !== undefined, 0x00ed);
    ...
    _readUserData(context) {
        ...
        if (isFirestoreValue(this._protoValue)) {
            ...
            this._protoValue = commonE122c13e_node.parseData(this.value, context);
        }
    }
}
...
class MapValue extends Expression {
    ...
    _toProto(serializer) {
        return commonE122c13e_node.toMapValue(serializer, this.plainObject);
    }
}
/**
 * @beta
...
class Ordering {
    ...
    _toProto(serializer) {
        return {
            mapValue: {
                fields: {
                    direction: commonE122c13e_node.toStringValue(this.direction),
...
function isSelectable(val) {
    const candidate = val;
    return (candidate.selectable && commonE122c13e_node.isString(candidate.alias) && isExpr(candidate.expr));
}
...
function isAliasedAggregate(val) {
    const candidate = val;
    return (commonE122c13e_node.isString(candidate.alias) &&
...
function toPipelineBooleanExpr(f) {
    if (f instanceof commonE122c13e_node.FieldFilter) {
        ...
        switch (f.op) {
            ...
            default:
                commonE122c13e_node.fail(0x9047);
        }
    }
    else if (f instanceof commonE122c13e_node.CompositeFilter) {
        switch (f.op) {
            ...
            default:
                commonE122c13e_node.fail(0x89ea);
        }
    }
...
function toPipeline(query, db) {
    let pipeline;
    if (commonE122c13e_node.isCollectionGroupQuery(query)) {
        pipeline = db.pipeline().collectionGroup(query.collectionGroup);
    }
    else if (commonE122c13e_node.isDocumentQuery$1(query)) {
        pipeline = db.pipeline().documents([commonE122c13e_node.doc(db, query.path.canonicalString())]);
    }
    else {
    ...
    // orders
    const orders = commonE122c13e_node.queryNormalizedOrderBy(query);
...
class AddFields extends Stage {
    ...
    get _optionsUtil() {
        return new commonE122c13e_node.OptionsUtil({});
    }
    ...
    _toProto(serializer) {
        return {
            ...
            args: [commonE122c13e_node.toMapValue(serializer, this.fields)]
        };
    }
    _readUserData(context) {
...
class Aggregate extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [
                commonE122c13e_node.toMapValue(serializer, this.accumulators),
                commonE122c13e_node.toMapValue(serializer, this.groups)
            ]
        };
    }
    _readUserData(context) {
...
class Distinct extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [commonE122c13e_node.toMapValue(serializer, this.groups)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
    ...
    _toProto(serializer) {
        return {
            ...
            args: [
                ...
                commonE122c13e_node.toStringValue(this.distanceMeasure)
            ]
        };
    }
    _readUserData(context) {
...
class Limit extends Stage {
    ...
    constructor(limit, options) {
        commonE122c13e_node.hardAssert(!isNaN(limit) && limit !== Infinity && limit !== -Infinity, 0x882c);
        super(options);
        this.limit = limit;
    }
    /**
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [commonE122c13e_node.toNumber(serializer, this.limit)]
        };
    }
}
/**
...
class Offset extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [commonE122c13e_node.toNumber(serializer, this.offset)]
        };
    }
}
/**
...
class Select extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [commonE122c13e_node.toMapValue(serializer, this.selections)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
class Sample extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [commonE122c13e_node.toNumber(serializer, this.rate), commonE122c13e_node.toStringValue(this.mode)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
class Union extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [commonE122c13e_node.toPipelineValue(this.other._toProto(serializer))]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
class Replace extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [this.map._toProto(serializer), commonE122c13e_node.toStringValue(Replace.MODE)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
function readUserDataHelper(expressionMap, context) {
    if (commonE122c13e_node.isUserData(expressionMap)) {
...
class PipelineSource {
    ...
    collection(collectionOrOptions) {
        ...
        const options = commonE122c13e_node.isString(collectionOrOptions) ||
            commonE122c13e_node.isCollectionReference(collectionOrOptions)
            ? {}
            : collectionOrOptions;
        const collectionRefOrString = commonE122c13e_node.isString(collectionOrOptions) ||
            commonE122c13e_node.isCollectionReference(collectionOrOptions)
            ? collectionOrOptions
            : collectionOrOptions.collection;
        // Validate that a user provided reference is for the same Firestore DB
        if (commonE122c13e_node.isCollectionReference(collectionRefOrString)) {
            this._validateReference(collectionRefOrString);
        }
        // Convert user land convenience types to internal types
        const normalizedCollection = commonE122c13e_node.isString(collectionRefOrString)
    ...
    collectionGroup(collectionIdOrOptions) {
        ...
        let collectionId;
        let options;
        if (commonE122c13e_node.isString(collectionIdOrOptions)) {
    ...
    documents(docsOrOptions) {
        ...
        docs
            .filter(v => v instanceof commonE122c13e_node.DocumentReference)
            .forEach(dr => this._validateReference(dr));
        // Convert user land convenience types to internal types
        const normalizedDocs = docs.map(doc => commonE122c13e_node.isString(doc) ? doc : doc.path);
        // Create stage object
    ...
    _validateReference(reference) {
        ...
        if (!refDbId.isEqual(this.databaseId)) {
            throw new commonE122c13e_node.FirestoreError(commonE122c13e_node.Code.INVALID_ARGUMENT, `Invalid ${reference instanceof commonE122c13e_node.CollectionReference
                ? 'CollectionReference'
                : 'DocumentReference'}. ` +
...
class PipelineResult {
    ...
    get(fieldPath) {
        ...
        const value = this._fields.field(commonE122c13e_node.fieldPathFromArgument('DocumentSnapshot.get', fieldPath));
        if (value !== null) {
...
function pipelineResultEqual(left, right) {
    ...
    return (commonE122c13e_node.isOptionalEqual(left._ref, right._ref, commonE122c13e_node.refEqual) &&
        commonE122c13e_node.isOptionalEqual(left._fields, right._fields, (l, r) => l.isEqual(r)));
}
...
function selectablesToMap(selectables) {
    ...
    for (const selectable of selectables) {
        ...
        if (typeof selectable === 'string') {
            ...
            commonE122c13e_node.fail(0x5319, { selectable });
        }
        if (result.get(alias) !== undefined) {
            throw new commonE122c13e_node.FirestoreError('invalid-argument', `Duplicate alias or field '${alias}'`);
        }
...
function aliasedAggregateToMap(aliasedAggregatees) {
    return aliasedAggregatees.reduce((map, selectable) => {
        if (map.get(selectable.alias) !== undefined) {
            throw new commonE122c13e_node.FirestoreError('invalid-argument', `Duplicate alias or field '${selectable.alias}'`);
        }
...
function vectorToExpr(value) {
    if (value instanceof Expression) {
        ...
        const result = constant(commonE122c13e_node.vector(value));
        return result;
    }
    else {
        throw new Error('Unsupported value: ' + typeof value);
...
class Pipeline$1 {
    ...
    removeFields(fieldValueOrOptions, ...additionalFields) {
        // Process argument union(s) from method overloads
        const options = isField(fieldValueOrOptions) || commonE122c13e_node.isString(fieldValueOrOptions)
            ? {}
            : fieldValueOrOptions;
        const fields = isField(fieldValueOrOptions) || commonE122c13e_node.isString(fieldValueOrOptions)
            ? [fieldValueOrOptions, ...additionalFields]
            : fieldValueOrOptions.fields;
        // Convert user land convenience types to internal types
        const convertedFields = fields.map(f => commonE122c13e_node.isString(f) ? field(f) : f);
        // Create stage object
    ...
    select(selectionOrOptions, ...additionalSelections) {
        // Process argument union(s) from method overloads
        const options = isSelectable(selectionOrOptions) || commonE122c13e_node.isString(selectionOrOptions)
            ? {}
            : selectionOrOptions;
        const selections = isSelectable(selectionOrOptions) || commonE122c13e_node.isString(selectionOrOptions)
    ...
    offset(offsetOrOptions) {
        ...
        let options;
        let offset;
        if (commonE122c13e_node.isNumber$1(offsetOrOptions)) {
            options = {};
            offset = offsetOrOptions;
        }
        else {
    ...
    limit(limitOrOptions) {
        // Process argument union(s) from method overloads
        const options = commonE122c13e_node.isNumber$1(limitOrOptions) ? {} : limitOrOptions;
        const limit = commonE122c13e_node.isNumber$1(limitOrOptions)
            ? limitOrOptions
    ...
    distinct(groupOrOptions, ...additionalGroups) {
        // Process argument union(s) from method overloads
        const options = commonE122c13e_node.isString(groupOrOptions) || isSelectable(groupOrOptions)
            ? {}
            : groupOrOptions;
        const groups = commonE122c13e_node.isString(groupOrOptions) || isSelectable(groupOrOptions)
    ...
    replaceWith(valueOrOptions) {
        // Process argument union(s) from method overloads
        const options = commonE122c13e_node.isString(valueOrOptions) || isExpr(valueOrOptions) ? {} : valueOrOptions;
        const fieldNameOrExpr = commonE122c13e_node.isString(valueOrOptions) || isExpr(valueOrOptions)
            ? valueOrOptions
            : valueOrOptions.map;
        // Convert user land convenience types to internal types
    ...
    sample(documentsOrOptions) {
        // Process argument union(s) from method overloads
        const options = commonE122c13e_node.isNumber$1(documentsOrOptions) ? {} : documentsOrOptions;
        let rate;
        let mode;
        if (commonE122c13e_node.isNumber$1(documentsOrOptions)) {
            rate = documentsOrOptions;
            mode = 'documents';
        }
        else if (commonE122c13e_node.isNumber$1(documentsOrOptions.documents)) {
    ...
    unnest(selectableOrOptions, indexField) {
        ...
        if (commonE122c13e_node.isString(indexFieldName)) {
...
function execute(pipelineOrOptions) {
    ...
    const firestore = commonE122c13e_node.cast(pipeline._db, commonE122c13e_node.Firestore);
    const client = commonE122c13e_node.ensureFirestoreConfigured(firestore);
    const userDataReader = commonE122c13e_node.newUserDataReader(firestore);
    ...
    const structuredPipelineOptions = new commonE122c13e_node.StructuredPipelineOptions(rest, rawOptions);
    structuredPipelineOptions._readUserData(context);
    const structuredPipeline = new commonE122c13e_node.StructuredPipeline(pipeline, structuredPipelineOptions);
    return commonE122c13e_node.firestoreClientExecutePipeline(client, structuredPipeline).then(result => {
        ...
        const docs = result
            ...
            ? new commonE122c13e_node.DocumentReference(firestore, null, element.key)
...
commonE122c13e_node.Firestore.prototype.pipeline = function () {
    return new PipelineSource(this._databaseId, (stages) => {
        return new Pipeline(this, stages);
    });
};

exports._internalPipelineToExecutePipelineRequestProto = commonE122c13e_node._internalPipelineToExecutePipelineRequestProto;
