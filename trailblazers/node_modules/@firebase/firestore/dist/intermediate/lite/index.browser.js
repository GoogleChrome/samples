...
import { _ as a, a as o, F as h, b as c, c as u, d as l, O as _, e as f, f as d, g, h as m, i as p, j as w, q as y, k as P, l as D, m as b, P as v, n as k, o as O, p as S, r as C, s as x, C as j, t as z, u as tt, D as et, v as st, S as it, w as rt, x as nt, y as ot, z as ht, A as ct } from "./common.browser.js";
...
class __PRIVATE_ExponentialBackoff {
     ...
     */    A(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                r > 0 && a("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.u} ms, delay with jitter: ${e} ms, last attempt: ${i} ms ago)`), 
 ...
 */ function getAggregate(t, e) {
    const i = f(t.firestore, h), r = d(i), a = g(e, ((t, e) => new __PRIVATE_AggregateImpl(e, t.aggregateType, t._internalFieldPath)));
    // Run the aggregation and convert the results
    return m(r, t._query, a).then((e => function __PRIVATE_convertToAggregateQuerySnapshot(t, e, i) {
        const r = new p(t), a = new AggregateQuerySnapshot(e, r, i);
        return a;
    }
    /**
 ...
 */ class WriteBatch {
    ...
    set(t, e, i) {
        ...
        const r = __PRIVATE_validateReference(t, this._firestore), a = D(r.converter, e, i), o = b(this._dataReader, "WriteBatch.set", r._key, a, null !== r.converter, i);
        return this._mutations.push(o.toMutation(r._key, v.none())), this;
    }
    update(t, e, i, ...r) {
        this._verifyNotCommitted();
        ...
        // performing validation.
                let o;
        return o = "string" == typeof (e = lt(e)) || e instanceof k ? O(this._dataReader, "WriteBatch.update", a._key, e, i, r) : S(this._dataReader, "WriteBatch.update", a._key, e), 
        this._mutations.push(o.toMutation(a._key, v.exists(!0))), this;
    }
    /**
...
class __PRIVATE_AsyncQueueImpl {
    constructor(t = Promise.resolve()) {
        ...
        this.L = () => {
            const t = getDocument();
            t && a(dt, "Visibility state changed to " + t.visibilityState), this.P.T();
        }, this.W = t;
        const e = getDocument();
 ...
 */ (t)) throw t;
 // Failure will be handled by AsyncQueue
                                a(dt, "Operation failed with retryable error: " + t);
            }
            this.k.length > 0 && 
 ...
 */ class Transaction {
     ...
     */    get(t) {
        ...
        return this._transaction.lookup([ e._key ]).then((t => {
            ...
            const r = t[0];
            if (r.isFoundDocument()) return new ct(this._firestore, i, r.key, r, e.converter);
            if (r.isNoDocument()) return new ct(this._firestore, i, e._key, null, e.converter);
            throw rt(18433, {
                doc: r
            });
        }));
    ...
    set(t, e, i) {
        const r = __PRIVATE_validateReference(t, this._firestore), a = D(r.converter, e, i), o = b(this._dataReader, "Transaction.set", r._key, a, null !== r.converter, i);
    ...
    update(t, e, i, ...r) {
        ...
        // performing validation.
                let o;
        return o = "string" == typeof (e = lt(e)) || e instanceof k ? O(this._dataReader, "Transaction.update", a._key, e, i, r) : S(this._dataReader, "Transaction.update", a._key, e), 
 ...
 */ !function __PRIVATE_registerFirestore() {
    o(`${i}_lite`), t(new r("firestore/lite", ((t, {instanceIdentifier: e, options: i}) => {
        const r = t.getProvider("app").getImmediate(), a = new h(new c(t.getProvider("auth-internal")), new u(r, t.getProvider("app-check-internal")), l(r, e), r);
