import { FirebaseError, isCloudWorkstation, getDefaultEmulatorHostnameAndPort, pingServer, deepEqual, createMockUserToken, getModularInstance } from '@firebase/util';
