import { FirebaseError as e, isCloudWorkstation as t, getDefaultEmulatorHostnameAndPort as r, pingServer as n, deepEqual as i, createMockUserToken as s, getModularInstance as o } from "@firebase/util";

import { Logger as a, LogLevel as u } from "@firebase/logger";

import { Integer as _ } from "@firebase/webchannel-wrapper/bloom-blob";

import { _isFirebaseServerApp as c, _getProvider, getApp as l, _removeServiceInstance as h } from "@firebase/app";
...
/** AppCheck token provider for the Lite SDK. */ class __PRIVATE_LiteAppCheckTokenProvider {
    constructor(e, t) {
        this.m = t, this.appCheck = null, this.P = null, c(e) && e.settings.appCheckToken && (this.P = e.settings.appCheckToken), 
        t.onInit((e => {
            this.appCheck = e;
        }));
    }
 ...
 */ class BasePath {
    ...
    static extractNumericId(e) {
        return _.fromString(e.substring(4, e.length - 2));
    }
}
...
function getFirestore(e, t) {
    const n = "object" == typeof e ? e : l(), i = "string" == typeof e ? e : t || "(default)", s = _getProvider(n, "firestore/lite").getImmediate({
        identifier: i
    });
    if (!s._initialized) {
        const e = r("firestore");
 ...
 */ function connectFirestoreEmulator(e, r, o, a = {}) {
    ...
    u && n(`https://${l}`), _.host !== U && _.host !== l && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
    const h = {
        ..._,
        host: l,
        ssl: u,
 ...
 */ function terminate(e) {
    return e = __PRIVATE_cast(e, Firestore), h(e.app, "firestore/lite"), e._delete();
}
...
function collection(e, t, ...r) {
    if (e = o(e), __PRIVATE_validateNonEmptyArgument("collection", "path", t), e instanceof Firestore) {
 ...
 */ function refEqual(e, t) {
    return e = o(e), t = o(t), (e instanceof DocumentReference || e instanceof CollectionReference) && (t instanceof DocumentReference || t instanceof CollectionReference) && (e.firestore === t.firestore && e.path === t.path && e.converter === t.converter);
}
 ...
 */ function queryEqual(e, t) {
    return e = o(e), t = o(t), e instanceof Query && t instanceof Query && (e.firestore === t.firestore && __PRIVATE_queryEquals(e._query, t._query) && e.converter === t.converter);
}
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
    ...
    isEqual(e) {
        return e instanceof __PRIVATE_ArrayUnionFieldValueImpl && i(this.te, e.te);
    }
}
...
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
    ...
    isEqual(e) {
        return e instanceof __PRIVATE_ArrayRemoveFieldValueImpl && i(this.te, e.te);
    }
}
 ...
 */ function __PRIVATE_parseData(e, t) {
    ...
    // from firestore-exp.
    e = o(e))) return __PRIVATE_validatePlainObject("Unsupported field value:", t, e), 
 ...
 */ function __PRIVATE_fieldPathFromArgument(e, t, r) {
    ...
    // FieldPath.
    t = o(t)) instanceof FieldPath) return t._internalPath;
...
/** Helper function to create a bound from a document or fields */ function __PRIVATE_newQueryBoundFromDocOrFields(e, t, r, n) {
    if (r[0] = o(r[0]), r[0] instanceof DocumentSnapshot) return function __PRIVATE_newQueryBoundFromDocument(e, t, r, n, i) {
...
function updateDoc(e, t, r, ...n) {
    ...
    // performing validation.
        let s;
    s = "string" == typeof (t = o(t)) || t instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(i, "updateDoc", e._key, t, r, n) : __PRIVATE_parseUpdateData(i, "updateDoc", e._key, t);
