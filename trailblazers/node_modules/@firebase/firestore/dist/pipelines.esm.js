import { F as Firestore, d as FirestoreError, b4 as __PRIVATE_isString, b5 as F, aT as documentId$1, j as __PRIVATE_fieldPathFromArgument, b6 as __PRIVATE_hardAssert, b7 as __PRIVATE_parseData, b8 as __PRIVATE_toStringValue, b9 as __PRIVATE_isCollectionReference, D as DocumentReference, e as D, av as CollectionReference, ba as __PRIVATE_isOptionalEqual, y as __PRIVATE_cast, z as ensureFirestoreConfigured, g as __PRIVATE_newUserDataReader, H as __PRIVATE_ExpUserDataWriter, bb as __PRIVATE_firestoreClientExecutePipeline, bc as __PRIVATE_isPlainObject, aA as VectorValue, b2 as vector, u as __PRIVATE_isCollectionGroupQuery, bd as __PRIVATE_isDocumentQuery$1, a6 as doc, q as __PRIVATE_queryNormalizedOrderBy, be as OptionsUtil, a_ as refEqual, bf as __PRIVATE_isNumber$1, bg as __PRIVATE_StructuredPipelineOptions, bh as __PRIVATE_toMapValue, i as FieldFilter, U as fail, C as CompositeFilter, bi as toNumber, bj as __PRIVATE_toPipelineValue, bk as __PRIVATE_isUserData, bl as StructuredPipeline } from './common-edb5d170.esm.js';
export { bm as _internalPipelineToExecutePipelineRequestProto } from './common-edb5d170.esm.js';
import '@firebase/app';
 ...
 */ function execute(e) {
    const n = e instanceof Pipeline$1 ? {
        pipeline: e
    } : e, {pipeline: t, rawOptions: r, ...i} = n, s = __PRIVATE_cast(t._db, Firestore), o = ensureFirestoreConfigured(s), u = __PRIVATE_newUserDataReader(s).A(3 /* UserDataSource.Argument */ , "execute");
    t._readUserData(u);
    const _ = new __PRIVATE_ExpUserDataWriter(s), l = new __PRIVATE_StructuredPipelineOptions(i, r);
    l._readUserData(u);
    ...
    return __PRIVATE_firestoreClientExecutePipeline(o, c).then((e => {
        ...
        const n = e.length > 0 ? e[0].executionTime?.toTimestamp() : void 0, r = e.filter((e => !!e.fields)).map((e => new PipelineResult(_, e.fields, e.key?.path ? new DocumentReference(s, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp())));
