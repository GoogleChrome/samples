...
import { _ as r, a as o, F as h, b as c, c as u, d as l, O as _, e as d, f, g, h as m, i as p, j as w, q as y, k as P, l as D, m as b, P as v, n as k, o as O, p as S, r as C, s as x, C as j, t as z, u as tt, D as et, v as st, S as it, w as rt, x as nt, y as ot, z as ht, A as ct } from "./common-dad96879.rn.esm.js";
...
class __PRIVATE_ExponentialBackoff {
     ...
     */ , r = 6e4) {
        this.t = t, this.timerId = e, this.i = i, this.o = a, this.h = r, this.u = 0, this.l = null, 
     ...
     */    A(t) {
        ...
        // honored as such).
        const e = Math.floor(this.u + this.p()), i = Math.max(0, Date.now() - this._), a = Math.max(0, e - i);
        // Guard against lastAttemptTime being in the future due to a clock change.
                a > 0 && r("ExponentialBackoff", `Backing off for ${a} ms (base delay: ${this.u} ms, delay with jitter: ${e} ms, last attempt: ${i} ms ago)`), 
        this.l = this.t.enqueueAfterDelay(this.timerId, a, (() => (this._ = Date.now(), 
        t()))), 
 ...
 */ function getAggregate(t, e) {
    const i = d(t.firestore, h), a = f(i), r = g(e, ((t, e) => new __PRIVATE_AggregateImpl(e, t.aggregateType, t._internalFieldPath)));
    // Run the aggregation and convert the results
    return m(a, t._query, r).then((e => function __PRIVATE_convertToAggregateQuerySnapshot(t, e, i) {
        const a = new p(t), r = new AggregateQuerySnapshot(e, a, i);
        return r;
    }
    /**
 ...
 */ class WriteBatch {
    ...
    set(t, e, i) {
        ...
        const a = __PRIVATE_validateReference(t, this._firestore), r = D(a.converter, e, i), o = b(this._dataReader, "WriteBatch.set", a._key, r, null !== a.converter, i);
        return this._mutations.push(o.toMutation(a._key, v.none())), this;
    }
    update(t, e, i, ...a) {
        this._verifyNotCommitted();
        ...
        // performing validation.
                let o;
        return o = "string" == typeof (e = lt(e)) || e instanceof k ? O(this._dataReader, "WriteBatch.update", r._key, e, i, a) : S(this._dataReader, "WriteBatch.update", r._key, e), 
        this._mutations.push(o.toMutation(r._key, v.exists(!0))), this;
    }
    /**
 ...
 */ class Transaction$1 {
    ...
    async commit() {
        ...
        // a `verify` operation.
        t.forEach(((t, e) => {
            const i = et.fromPath(e);
            this.mutations.push(new st(i, this.precondition(i)));
...
class __PRIVATE_TransactionRunner {
    constructor(t, e, i, a, r) {
        this.asyncQueue = t, this.datastore = e, this.options = i, this.updateFunction = a, 
        this.deferred = r, this.I = i.maxAttempts, this.P = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */);
    }
 ...
 */ class DelayedOperation {
    constructor(t, e, i, a, r) {
        this.asyncQueue = t, this.timerId = e, this.targetTimeMs = i, this.op = a, this.removalCallback = r, 
     ...
     */    static createAndSchedule(t, e, i, a, r) {
        const o = Date.now() + i, h = new DelayedOperation(t, e, o, a, r);
        return h.start(i), h;
    }
    /**
 ...
 */ (t)) throw t;
 // Failure will be handled by AsyncQueue
    ...
    enqueueAfterDelay(t, e, i) {
        ...
        const a = DelayedOperation.createAndSchedule(this, t, e, i, (t => this.G(t)));
        return this.O.push(a), a;
    }
    U() {
        this.S && rt(47125, {
 ...
 */ class Transaction {
     ...
     */    get(t) {
        const e = __PRIVATE_validateReference(t, this._firestore), i = new p(this._firestore);
        return this._transaction.lookup([ e._key ]).then((t => {
            if (!t || 1 !== t.length) return rt(24041);
            const a = t[0];
            if (a.isFoundDocument()) return new ct(this._firestore, i, a.key, a, e.converter);
            if (a.isNoDocument()) return new ct(this._firestore, i, e._key, null, e.converter);
            throw rt(18433, {
                doc: a
            });
        }));
    ...
    set(t, e, i) {
        const a = __PRIVATE_validateReference(t, this._firestore), r = D(a.converter, e, i), o = b(this._dataReader, "Transaction.set", a._key, r, null !== a.converter, i);
        return this._transaction.set(a._key, o), this;
    }
    update(t, e, i, ...a) {
        const r = __PRIVATE_validateReference(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let o;
        return o = "string" == typeof (e = lt(e)) || e instanceof k ? O(this._dataReader, "Transaction.update", r._key, e, i, a) : S(this._dataReader, "Transaction.update", r._key, e), 
        this._transaction.update(r._key, o), this;
    }
    /**
     * Deletes the document referred to by the provided {@link DocumentReference}.
     *
 ...
 */ function runTransaction(t, e, i) {
    ...
    }(), a, r, (i => e(new Transaction(t, i))), o).V(), o.promise;
}
 ...
 */ !function __PRIVATE_registerFirestore() {
    o(`${i}_lite`), t(new a("firestore/lite", ((t, {instanceIdentifier: e, options: i}) => {
        const a = t.getProvider("app").getImmediate(), r = new h(new c(t.getProvider("auth-internal")), new u(a, t.getProvider("app-check-internal")), l(a, e), a);
        return i && r._setSettings(i), r;
    }), "PUBLIC").setMultipleInstances(!0)), 
    // RUNTIME_ENV and BUILD_TARGET are replaced by real values during the compilation
    e("firestore-lite", _t, "rn"), e("firestore-lite", _t, "esm2020");
}();
...
//# sourceMappingURL=index.rn.esm.js.map
