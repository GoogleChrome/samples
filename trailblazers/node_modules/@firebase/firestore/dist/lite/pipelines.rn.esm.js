import { O as _, av as n, aw as s, ax as k, g, s as x, ay as E, az as T, af as A, j as w, aA as I, aB as V, aq as R, am as $, aC as F, aD as U, aE as M, M as L, aF as q, aG as N, w as rt, aH as B, aI as H, aJ as G, aK as W, aL as K, I as J, C as j, J as Q, aM as X, f, e as d, k as P, i as p, aN as Y, F as h } from "./common-dad96879.rn.esm.js";
 ...
 */ class Expression {
    ...
    timestampTruncate(e, n) {
        const t = [ this, __PRIVATE_valueToDefaultExpr$1(E(e) ? e.toLowerCase() : e) ];
...
function _field(e, n) {
    return new Field("string" == typeof e ? T === e ? A()._internalPath : w("field", e) : e._internalPath, n);
}
 ...
 */ class Constant extends Expression {
     ...
     * @internal
     */    _toProto(e) {
        return I(void 0 !== this._protoValue, 237), this._protoValue;
    }
    /**
     * @private
     * @internal
     */    _readUserData(e) {
        e = this._methodName ? e.te({
            methodName: this._methodName
        }) : e, __PRIVATE_isFirestoreValue(this._protoValue) || (this._protoValue = s(this.value, e));
    }
}
...
function timestampTruncate(e, n, t) {
    const r = E(n) ? __PRIVATE_valueToDefaultExpr$1(n.toLowerCase()) : n;
...
function __PRIVATE_isSelectable(e) {
    const n = e;
    return n.selectable && E(n.alias) && __PRIVATE_isExpr(n.expr);
}
...
function __PRIVATE_isAliasedAggregate(e) {
    const n = e;
    return E(n.alias) && n.aggregate instanceof AggregateFunction;
}
...
/* eslint @typescript-eslint/no-explicit-any: 0 */ function __PRIVATE_toPipelineBooleanExpr(e) {
    ...
    } else if (e instanceof B) switch (e.op) {
...
function __PRIVATE_toPipeline(e, n) {
    let t;
    t = U(e) ? n.pipeline().collectionGroup(e.collectionGroup) : M(e) ? n.pipeline().documents([ L(n, e.path.canonicalString()) ]) : n.pipeline().collection(e.path.canonicalString());
    // filters
 ...
 */ class __PRIVATE_FindNearest extends Stage {
     ...
     */    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.field._toProto(e), this.vectorValue._toProto(e), V(this.distanceMeasure) ]
        };
    }
    _readUserData(e) {
 ...
 */ class __PRIVATE_Limit extends Stage {
    ...
    constructor(e, n) {
        I(!isNaN(e) && e !== 1 / 0 && e !== -1 / 0, 34860), super(n), this.limit = e;
    }
    /**
     * @internal
     * @private
 ...
 */ class __PRIVATE_Sample extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ H(e, this.rate), V(this.mode) ]
        };
    }
    _readUserData(e) {
        super._readUserData(e);
 ...
 */ class __PRIVATE_Replace extends Stage {
    ...
    _toProto(e) {
        return {
            ...super._toProto(e),
            args: [ this.map._toProto(e), V(__PRIVATE_Replace.ae) ]
        };
    }
    _readUserData(e) {
 ...
 */ function __PRIVATE_readUserDataHelper(e, n) {
    return W(e) ? e._readUserData(n) : Array.isArray(e) ? e.forEach((e => e._readUserData(n))) : e.forEach((e => e._readUserData(n))), 
    e;
}
 ...
 */ class PipelineSource {
    ...
    collection(e) {
        ...
        const n = E(e) || K(e) ? {} : e, t = E(e) || K(e) ? e : e.collection;
        // Validate that a user provided reference is for the same Firestore DB
        K(t) && this._validateReference(t);
        // Convert user land convenience types to internal types
                const r = E(t) ? t : t.path, i = new __PRIVATE_CollectionSource(r, n);
        // Create stage object
    ...
    documents(e) {
        ...
        t.filter((e => e instanceof J)).forEach((e => this._validateReference(e)));
        // Convert user land convenience types to internal types
        const r = t.map((e => E(e) ? e : e.path)), i = new __PRIVATE_DocumentsSource(r, n);
        // Create stage object
                // Add stage to the pipeline
        return this._createPipeline([ i ]);
    }
    ...
    _validateReference(e) {
        ...
        if (!n.isEqual(this.databaseId)) throw new x(j.INVALID_ARGUMENT, `Invalid ${e instanceof Q ? "CollectionReference" : "DocumentReference"}. The project ID ("${n.projectId}") or the database ("${n.database}") does not match the project ID ("${this.databaseId.projectId}") and database ("${this.databaseId.database}") of the target database of this Pipeline.`);
    }
}
 ...
 */ class PipelineResult {
    ...
    get(e) {
        ...
        const n = this._fields.field(w("DocumentSnapshot.get", e));
 ...
 */ function __PRIVATE_selectablesToMap(e) {
    ...
    for (const t of e) {
        ...
        r = t.expr) : rt(21273, {
            selectable: t
        }), void 0 !== n.get(e)) throw new x("invalid-argument", `Duplicate alias or field '${e}'`);
        n.set(e, r);
    }
    return n;
}
 ...
 */
    return function __PRIVATE_valueToDefaultExpr(e) {
        ...
        if (e instanceof Expression) return e;
        t = n(e) ? map(e) : e instanceof Array ? array(e) : __PRIVATE__constant(e, void 0);
        return t;
    }
    /**
 * @license
...
class Pipeline {
    ...
    removeFields(e, ...n) {
        // Process argument union(s) from method overloads
        const t = __PRIVATE_isField(e) || E(e) ? {} : e, r = (__PRIVATE_isField(e) || E(e) ? [ e, ...n ] : e.fields).map((e => E(e) ? field(e) : e)), i = new __PRIVATE_RemoveFields(r, t);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    select(e, ...n) {
        // Process argument union(s) from method overloads
        const t = __PRIVATE_isSelectable(e) || E(e) ? {} : e, r = __PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || E(e) ? [ e, ...n ] : e.selections), i = new __PRIVATE_Select(r, t);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    where(e) {
    ...
    limit(e) {
        // Process argument union(s) from method overloads
        const n = X(e) ? {} : e, t = X(e) ? e : e.limit, r = new __PRIVATE_Limit(t, n);
        // Add stage to the pipeline
        return this._addStage(r);
    }
    distinct(e, ...n) {
        // Process argument union(s) from method overloads
        const t = E(e) || __PRIVATE_isSelectable(e) ? {} : e, r = __PRIVATE_selectablesToMap(E(e) || __PRIVATE_isSelectable(e) ? [ e, ...n ] : e.groups), i = new __PRIVATE_Distinct(r, t);
        // Add stage to the pipeline
        return this._addStage(i);
    }
    aggregate(e, ...n) {
        ...
        const t = __PRIVATE_isAliasedAggregate(e) ? {} : e, r = __PRIVATE_isAliasedAggregate(e) ? [ e, ...n ] : e.accumulators, i = __PRIVATE_isAliasedAggregate(e) ? [] : e.groups ?? [], s = function __PRIVATE_aliasedAggregateToMap(e) {
            return e.reduce(((e, n) => {
                if (void 0 !== e.get(n.alias)) throw new x("invalid-argument", `Duplicate alias or field '${n.alias}'`);
 ...
 */ (r), o = __PRIVATE_selectablesToMap(i), a = new __PRIVATE_Aggregate(o, s, t);
    ...
    replaceWith(e) {
        // Process argument union(s) from method overloads
        const n = E(e) || __PRIVATE_isExpr(e) ? {} : e, t = __PRIVATE_fieldOrExpression(E(e) || __PRIVATE_isExpr(e) ? e : e.map), r = new __PRIVATE_Replace(t, n);
        // Add stage to the pipeline
        return this._addStage(r);
    }
    sample(e) {
        ...
        const n = X(e) ? {} : e;
        let t, r;
        X(e) ? (t = e, r = "documents") : X(e.documents) ? (t = e.documents, r = "documents") : (t = e.percentage, 
        r = "percent");
        // Create stage object
 ...
 */ (e) ? ({other: t, ...n} = e) : (n = {}, t = e);
    ...
    unnest(e, n) {
        ...
        E(i) && (t.indexField = _field(i, "unnest"));
        // Create stage object
     ...
     */    rawStage(e, t, r) {
        // Convert user land convenience types to internal types
        const i = t.map((e => e instanceof Expression || e instanceof AggregateFunction ? e : n(e) ? function __PRIVATE__mapValue(e) {
            const n = new Map;
...
function execute(e) {
    const n = f(e._db), t = d(e._db, h), r = P(t).ue(3 /* UserDataSource.Argument */ , "execute");
    e._readUserData(r);
    const i = new p(t), s = new __PRIVATE_StructuredPipelineOptions({}, {});
    s._readUserData(r);
    ...
    return Y(n, o).then((n => {
        ...
        const t = n.length > 0 ? n[0].executionTime?.toTimestamp() : void 0, r = n.filter((e => !!e.fields)).map((n => new PipelineResult(i, n.fields, n.key?.path ? new J(e._db, null, n.key) : void 0, n.createTime?.toTimestamp(), n.updateTime?.toTimestamp())));
