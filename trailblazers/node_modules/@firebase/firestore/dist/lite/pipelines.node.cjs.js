...
class Expression {
    ...
    timestampTruncate(granularity, timezone) {
        const internalGranularity = common6d85b8e5_node.isString(granularity)
...
function _field(nameOrPath, methodName) {
    if (typeof nameOrPath === 'string') {
        if (common6d85b8e5_node.DOCUMENT_KEY_NAME === nameOrPath) {
            return new Field(common6d85b8e5_node.documentId()._internalPath, methodName);
        }
        return new Field(common6d85b8e5_node.fieldPathFromArgument('field', nameOrPath), methodName);
    }
    else {
...
class Constant extends Expression {
     ...
     */
    _toProto(_) {
        common6d85b8e5_node.hardAssert(this._protoValue !== undefined, 0x00ed);
    ...
    _readUserData(context) {
        ...
        if (isFirestoreValue(this._protoValue)) {
            ...
            this._protoValue = common6d85b8e5_node.parseData(this.value, context);
        }
    }
}
...
class MapValue extends Expression {
    ...
    _toProto(serializer) {
        return common6d85b8e5_node.toMapValue(serializer, this.plainObject);
    }
}
/**
 * @beta
...
class Ordering {
    ...
    _toProto(serializer) {
        return {
            mapValue: {
                fields: {
                    direction: common6d85b8e5_node.toStringValue(this.direction),
...
function isSelectable(val) {
    const candidate = val;
    return (candidate.selectable && common6d85b8e5_node.isString(candidate.alias) && isExpr(candidate.expr));
}
...
function isAliasedAggregate(val) {
    const candidate = val;
    return (common6d85b8e5_node.isString(candidate.alias) &&
...
function toPipelineBooleanExpr(f) {
    if (f instanceof common6d85b8e5_node.FieldFilter) {
        ...
        switch (f.op) {
            ...
            default:
                common6d85b8e5_node.fail(0x9047);
        }
    }
    else if (f instanceof common6d85b8e5_node.CompositeFilter) {
        switch (f.op) {
            ...
            default:
                common6d85b8e5_node.fail(0x89ea);
        }
    }
...
function toPipeline(query, db) {
    let pipeline;
    if (common6d85b8e5_node.isCollectionGroupQuery(query)) {
        pipeline = db.pipeline().collectionGroup(query.collectionGroup);
    }
    else if (common6d85b8e5_node.isDocumentQuery(query)) {
        pipeline = db.pipeline().documents([common6d85b8e5_node.doc(db, query.path.canonicalString())]);
    }
    else {
    ...
    // orders
    const orders = common6d85b8e5_node.queryNormalizedOrderBy(query);
...
class AddFields extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...
            args: [common6d85b8e5_node.toMapValue(serializer, this.fields)]
        };
    }
    _readUserData(context) {
...
class Aggregate extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [
                common6d85b8e5_node.toMapValue(serializer, this.accumulators),
                common6d85b8e5_node.toMapValue(serializer, this.groups)
            ]
        };
    }
    _readUserData(context) {
...
class Distinct extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common6d85b8e5_node.toMapValue(serializer, this.groups)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
    ...
    _toProto(serializer) {
        return {
            ...
            args: [
                ...
                common6d85b8e5_node.toStringValue(this.distanceMeasure)
            ]
        };
    }
    _readUserData(context) {
...
class Limit extends Stage {
    ...
    constructor(limit, options) {
        common6d85b8e5_node.hardAssert(!isNaN(limit) && limit !== Infinity && limit !== -Infinity, 0x882c);
        super(options);
        this.limit = limit;
    }
    /**
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common6d85b8e5_node.toNumber(serializer, this.limit)]
        };
    }
}
/**
...
class Offset extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common6d85b8e5_node.toNumber(serializer, this.offset)]
        };
    }
}
/**
...
class Select extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common6d85b8e5_node.toMapValue(serializer, this.selections)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
class Sample extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common6d85b8e5_node.toNumber(serializer, this.rate), common6d85b8e5_node.toStringValue(this.mode)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
class Union extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [common6d85b8e5_node.toPipelineValue(this.other._toProto(serializer))]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
class Replace extends Stage {
    ...
    _toProto(serializer) {
        return {
            ...super._toProto(serializer),
            args: [this.map._toProto(serializer), common6d85b8e5_node.toStringValue(Replace.MODE)]
        };
    }
    _readUserData(context) {
        super._readUserData(context);
...
function readUserDataHelper(expressionMap, context) {
    if (common6d85b8e5_node.isUserData(expressionMap)) {
...
class PipelineSource {
    ...
    collection(collectionOrOptions) {
        ...
        const options = common6d85b8e5_node.isString(collectionOrOptions) ||
            common6d85b8e5_node.isCollectionReference(collectionOrOptions)
            ? {}
            : collectionOrOptions;
        const collectionRefOrString = common6d85b8e5_node.isString(collectionOrOptions) ||
            common6d85b8e5_node.isCollectionReference(collectionOrOptions)
            ? collectionOrOptions
            : collectionOrOptions.collection;
        // Validate that a user provided reference is for the same Firestore DB
        if (common6d85b8e5_node.isCollectionReference(collectionRefOrString)) {
            this._validateReference(collectionRefOrString);
        }
        // Convert user land convenience types to internal types
        const normalizedCollection = common6d85b8e5_node.isString(collectionRefOrString)
    ...
    collectionGroup(collectionIdOrOptions) {
        ...
        let collectionId;
        let options;
        if (common6d85b8e5_node.isString(collectionIdOrOptions)) {
    ...
    documents(docsOrOptions) {
        ...
        docs
            .filter(v => v instanceof common6d85b8e5_node.DocumentReference)
            .forEach(dr => this._validateReference(dr));
        // Convert user land convenience types to internal types
        const normalizedDocs = docs.map(doc => common6d85b8e5_node.isString(doc) ? doc : doc.path);
        // Create stage object
    ...
    _validateReference(reference) {
        ...
        if (!refDbId.isEqual(this.databaseId)) {
            throw new common6d85b8e5_node.FirestoreError(common6d85b8e5_node.Code.INVALID_ARGUMENT, `Invalid ${reference instanceof common6d85b8e5_node.CollectionReference
                ? 'CollectionReference'
                : 'DocumentReference'}. ` +
...
class PipelineResult {
    ...
    get(fieldPath) {
        ...
        const value = this._fields.field(common6d85b8e5_node.fieldPathFromArgument('DocumentSnapshot.get', fieldPath));
        if (value !== null) {
...
function selectablesToMap(selectables) {
    ...
    for (const selectable of selectables) {
        ...
        if (typeof selectable === 'string') {
            ...
            common6d85b8e5_node.fail(0x5319, { selectable });
        }
        if (result.get(alias) !== undefined) {
            throw new common6d85b8e5_node.FirestoreError('invalid-argument', `Duplicate alias or field '${alias}'`);
        }
...
function aliasedAggregateToMap(aliasedAggregatees) {
    return aliasedAggregatees.reduce((map, selectable) => {
        if (map.get(selectable.alias) !== undefined) {
            throw new common6d85b8e5_node.FirestoreError('invalid-argument', `Duplicate alias or field '${selectable.alias}'`);
        }
...
function vectorToExpr(value) {
    if (value instanceof Expression) {
        ...
        const result = constant(common6d85b8e5_node.vector(value));
        return result;
    }
    else {
        throw new Error('Unsupported value: ' + typeof value);
...
class Pipeline {
    ...
    removeFields(fieldValueOrOptions, ...additionalFields) {
        // Process argument union(s) from method overloads
        const options = isField(fieldValueOrOptions) || common6d85b8e5_node.isString(fieldValueOrOptions)
            ? {}
            : fieldValueOrOptions;
        const fields = isField(fieldValueOrOptions) || common6d85b8e5_node.isString(fieldValueOrOptions)
            ? [fieldValueOrOptions, ...additionalFields]
            : fieldValueOrOptions.fields;
        // Convert user land convenience types to internal types
        const convertedFields = fields.map(f => common6d85b8e5_node.isString(f) ? field(f) : f);
        // Create stage object
    ...
    select(selectionOrOptions, ...additionalSelections) {
        // Process argument union(s) from method overloads
        const options = isSelectable(selectionOrOptions) || common6d85b8e5_node.isString(selectionOrOptions)
            ? {}
            : selectionOrOptions;
        const selections = isSelectable(selectionOrOptions) || common6d85b8e5_node.isString(selectionOrOptions)
    ...
    offset(offsetOrOptions) {
        ...
        let options;
        let offset;
        if (common6d85b8e5_node.isNumber(offsetOrOptions)) {
            options = {};
            offset = offsetOrOptions;
        }
        else {
    ...
    limit(limitOrOptions) {
        // Process argument union(s) from method overloads
        const options = common6d85b8e5_node.isNumber(limitOrOptions) ? {} : limitOrOptions;
        const limit = common6d85b8e5_node.isNumber(limitOrOptions)
            ? limitOrOptions
    ...
    distinct(groupOrOptions, ...additionalGroups) {
        // Process argument union(s) from method overloads
        const options = common6d85b8e5_node.isString(groupOrOptions) || isSelectable(groupOrOptions)
            ? {}
            : groupOrOptions;
        const groups = common6d85b8e5_node.isString(groupOrOptions) || isSelectable(groupOrOptions)
    ...
    replaceWith(valueOrOptions) {
        // Process argument union(s) from method overloads
        const options = common6d85b8e5_node.isString(valueOrOptions) || isExpr(valueOrOptions) ? {} : valueOrOptions;
        const fieldNameOrExpr = common6d85b8e5_node.isString(valueOrOptions) || isExpr(valueOrOptions)
            ? valueOrOptions
            : valueOrOptions.map;
        // Convert user land convenience types to internal types
    ...
    sample(documentsOrOptions) {
        // Process argument union(s) from method overloads
        const options = common6d85b8e5_node.isNumber(documentsOrOptions) ? {} : documentsOrOptions;
        let rate;
        let mode;
        if (common6d85b8e5_node.isNumber(documentsOrOptions)) {
            rate = documentsOrOptions;
            mode = 'documents';
        }
        else if (common6d85b8e5_node.isNumber(documentsOrOptions.documents)) {
    ...
    unnest(selectableOrOptions, indexField) {
        ...
        if (common6d85b8e5_node.isString(indexFieldName)) {
...
function execute(pipeline) {
    const datastore = common6d85b8e5_node.getDatastore(pipeline._db);
    const firestore = common6d85b8e5_node.cast(pipeline._db, common6d85b8e5_node.Firestore);
    const userDataReader = common6d85b8e5_node.newUserDataReader(firestore);
    ...
    return common6d85b8e5_node.invokeExecutePipeline(datastore, structuredPipeline).then(result => {
        ...
        const docs = result
            ...
            ? new common6d85b8e5_node.DocumentReference(pipeline._db, null, element.key)
 ...
 * ```
 */
common6d85b8e5_node.Firestore.prototype.pipeline = function () {
