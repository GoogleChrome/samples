 ...
 */
export function permute(tensor: any, axes: number[]): Tensor;
/**
...
export class Tensor {
     ...
     */
    sum(dim?: number | null, keepdim?: boolean): Tensor;
    /**
     ...
     */
    norm(p?: number | string, dim?: number | null, keepdim?: boolean): Tensor;
    /**
     ...
     */
    squeeze(dim?: number | number[] | null): Tensor;
    /**
