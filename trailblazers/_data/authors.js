export default {
  maya: {
    name: 'Maya',
    bio: {
      en: 'Adventure seeker and beach lover. Maya has traveled to over 30 countries, always looking for the perfect sunset.',
  ...
  ashok: {
    name: 'Ashok',
    bio: {
      en: 'Historian and city explorer. Ashok loves uncovering the hidden stories behind ancient architecture and bustling metropolitan streets.',
  ...
  julia: {
    name: 'Julia',
    bio: {
      en: 'Solo hiker and mountain enthusiast. Julia finds her peace in the high altitudes and rugged trails of the world.',
