...
(function() {
    ...
    const onShare = async () => {
      const title = "Río de Janeiro: La Ciudad de los Colores del Carnaval";
      const text = "Río es una ciudad que se representa a sí misma constantemente — cada ladera, playa y puesta de sol es un escenario." || title;
