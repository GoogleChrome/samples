...
(function() {
    ...
    const onShare = async () => {
      const title = "Reykjavik: Chasing the Northern Lights";
      const text = "Chase the ethereal Northern Lights in the world's northernmost capital. Relax in geothermal blue lagoons, marvel at waterfalls, and explore the unique quirky culture of Reykjavik." || title;
