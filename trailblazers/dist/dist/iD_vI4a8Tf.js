...
(function() {
    ...
    const onShare = async () => {
      const title = "Estambul: La Ciudad Entre Dos Mundos";
      const text = "Estambul es la única ciudad del mundo que se asienta sobre dos continentes — y lleva tres mil años tendiendo puentes entre ellos." || title;
