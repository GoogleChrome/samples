...
(function() {
    ...
    const onShare = async () => {
      const title = "Nueva York: Navegando por la Selva de Cristal";
      const text = "Navega por la jungla de concreto de Manhattan. Vive la energía eléctrica de Times Square y encuentra tranquilidad en Central Park en esta ciudad vibrante." || title;
