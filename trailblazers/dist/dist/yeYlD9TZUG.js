...
(function() {
    ...
    const onShare = async () => {
      const title = "Serengueti: Un Amanecer de Safari para Recordar";
      const text = "Vive la belleza cruda de un safari al amanecer en las llanuras infinitas del Serengueti." || title;
