...
(function() {
    ...
    const onShare = async () => {
      const title = "Valencia: Ciudad de Luz, Paella y Sueños Futuristas";
      const text = "Valencia seduce con su arquitectura futurista, su antigua catedral, sus playas bañadas por el sol y el lugar de nacimiento del plato de arroz más famoso del mundo." || title;
