...
(function() {
    ...
    const onShare = async () => {
      const title = "Serengeti: A Safari Sunrise to Remember";
      const text = "Experience the raw beauty of a sunrise safari on the endless plains of the Serengeti." || title;
