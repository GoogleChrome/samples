...
(function() {
    ...
    const onShare = async () => {
      const title = "Lisbon: City of Seven Hills and Endless Light";
      const text = "Lisbon is the Western European city that still has the quality of a secret — luminous, melancholy, and deeply human." || title;
