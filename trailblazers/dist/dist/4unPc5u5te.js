...
(function() {
    ...
    const onShare = async () => {
      const title = "Amsterdam: Life Along the Canals";
      const text = "Amsterdam was engineered against nature and for beauty — and five centuries later, it is still winning on both counts." || title;
