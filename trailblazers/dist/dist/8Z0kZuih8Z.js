...
(function() {
    ...
    const onShare = async () => {
      const title = "Praga: La Ciudad de Cuento de Hadas";
      const text = "Praga parece dibujada por alguien que solo había leído sobre ciudades en libros de cuentos — y de algún modo también es completamente real." || title;
