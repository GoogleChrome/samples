...
(function() {
    ...
    const onShare = async () => {
      const title = "Machu Picchu: Ecos de un Antiguo Imperio";
      const text = "Sube entre las nubes a la ciudadela inca de Machu Picchu. Explora ruinas cubiertas de niebla y vive la majestuosidad silenciosa de una ciudad perdida en lo alto de los Andes." || title;
