...
(function() {
    ...
    const onShare = async () => {
      const title = "París: Un Paseo de Medianoche por la Historia";
      const text = "Un paseo de medianoche por el Sena es la máxima expresión del romance parisino." || title;
