...
(async function () {
  ...
  const labels = {
    reviewing:   "Revisando tu comentario con IA…",
    downloading: "Descargando modelo de IA…",
    unavailable: "La moderación con IA no está disponible en este navegador. Tu comentario se publicará sin revisión.",
    Illegal:     "Contenido ilegal",
    Harmful:     "Contenido perjudicial",
...
(function() {
    ...
    const onShare = async () => {
      const title = "Petra: Secretos de la Ciudad Rosa";
      const text = "La Ciudad Rosa de Petra es una maravilla del mundo antiguo. Tallada en acantilados de arenisca por los nabateos, revela secretos al caminar por el Siq estrecho rocoso. Contempla el Tesoro, sube al Monasterio y vive la magia de noches iluminadas por velas bajo el cielo del desierto que se siente alienígena y profundamente humano a la vez." || title;
