...
(function() {
    ...
    const onShare = async () => {
      const title = "Bali: Finding Peace in the Rice Terraces";
      const text = "Find peace and spiritual renewal in Ubud, the cultural heart of Bali. Wander through lush rice terraces, visit sacred temples, and discover local crafts in hidden village workshops." || title;
