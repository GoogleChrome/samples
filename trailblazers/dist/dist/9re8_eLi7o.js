...
(function() {
    ...
    const onShare = async () => {
      const title = "Seúl: Donde los Palacios Antiguos Se Encuentran con los Futuros de Neón";
      const text = "Seúl es la ciudad que se reinventó sin olvidar de dónde venía — una cultura de cinco mil años corriendo a toda velocidad digital." || title;
