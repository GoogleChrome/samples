...
(function() {
    ...
    const onShare = async () => {
      const title = "Valencia: City of Light, Paella, and Futuristic Dreams";
      const text = "Valencia seduces with its futuristic architecture, ancient cathedral, sun-soaked beaches, and the birthplace of the world's most famous rice dish." || title;
