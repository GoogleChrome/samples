...
(function() {
    ...
    const onShare = async () => {
      const title = "サントリーニ島：青と白の夢";
      const text = "サントリーニ島の白い建物と青いドームは、世界で最も美しい景色の1つです。エーゲ海を見下ろす崖の上に位置するこの火山島は、夕日とロマンスの夢です。古代ミノア文明の都市を探索し、夕日を眺めながら新鮮な魚介類を堪能し、カマリの黒砂ビーチで泳ぎましょう。" || title;
