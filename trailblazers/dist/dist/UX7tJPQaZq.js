...
(function() {
    ...
    const onShare = async () => {
      const title = "Machu Picchu: Echoes of an Ancient Empire";
      const text = "Climb through the clouds to the ancient Incan citadel of Machu Picchu. Explore the mist-shrouded ruins, navigate intricate stonework, and experience the quiet majesty of a lost city perched high in the Andes." || title;
