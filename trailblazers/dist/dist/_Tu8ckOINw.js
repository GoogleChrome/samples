...
(function() {
    ...
    const onShare = async () => {
      const title = "Havana: Vintage Streets and Living History";
      const text = "Havana is the only city in the world where the past and present seem to inhabit the same breath." || title;
