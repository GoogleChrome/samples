...
(function() {
    ...
    const onShare = async () => {
      const title = "Ha Long Bay: Emerald Waters and Limestone Giants";
      const text = "Ha Long Bay looks like a myth made physical — thousands of limestone islands rising from green water as far as the eye can reach." || title;
