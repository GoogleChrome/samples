...
(async function () {
  ...
  const labels = {
    reviewing:   "Reviewing your comment with AI…",
    downloading: "Downloading AI model…",
    unavailable: "AI moderation is not available in this browser. Your comment will be posted without review.",
  ...
  const readyPromise = (async () => {
    try {
      if (
        ...
        await import('/samples/trailblazers/dist/js/prompt-api-polyfill.js');
      }
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (aiStatus !== null) {
        // phase 2: create session — show download progress only when needed
...
(function() {
    ...
    const onShare = async () => {
      const title = "Cape Town: Table Mountain from Below and Above";
      const text = "Table Mountain looms over a city of dramatic contrasts and stunning natural beauty. Cape Town offers everything from wild ocean beaches to world-class vineyards in the Constantia Valley. Hike up the famous mountain for 360-degree views, visit the penguins at Boulders Beach, and explore the history of Robben Island. It's a city where nature and culture meet in a spectacular dance of diversity." || title;
