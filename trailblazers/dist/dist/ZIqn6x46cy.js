...
(function() {
    ...
    const onShare = async () => {
      const title = "Queenstown: Adventure Capital of the Southern Hemisphere";
      const text = "Queenstown is where the mountains meet the lake and someone decided to invent bungee jumping — it has been accelerating ever since." || title;
