...
(function() {
    ...
    const onShare = async () => {
      const title = "Maldives: Overwater Paradise at the Edge of the World";
      const text = "The Maldives is the closest thing to disappearing into a postcard that the real world permits." || title;
