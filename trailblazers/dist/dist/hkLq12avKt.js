...
(function() {
    ...
    const onShare = async () => {
      const title = "Mexico City: Ancient Foundations, Modern Pulse";
      const text = "Mexico City is built on the ruins of an Aztec empire and vibrates with the energy of one of the largest cities on earth." || title;
