...
(function() {
    ...
    const onShare = async () => {
      const title = "Reikiavik: Persiguiendo la Aurora Boreal";
      const text = "Persigue auroras boreales en la capital más al norte. Relájate en lagunas azules geotérmicas y explora cataratas naturales mágicas." || title;
