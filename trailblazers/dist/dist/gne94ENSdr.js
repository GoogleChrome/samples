...
(function() {
    ...
    const onShare = async () => {
      const title = "Buenos Aires: Tango Nights and Belle Époque Grandeur";
      const text = "Buenos Aires is the city that invented melancholy as an art form, set it to music, and then danced to it until dawn." || title;
