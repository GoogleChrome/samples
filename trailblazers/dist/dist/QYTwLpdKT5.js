...
(function() {
    ...
    const onShare = async () => {
      const title = "Bali: Encontrando la Paz en las Terrazas de Arroz";
      const text = "Encuentra paz en Ubud, el corazón cultural de Bali. Pasea entre terrazas arrozales verdes y descubre templos sagrados únicos." || title;
