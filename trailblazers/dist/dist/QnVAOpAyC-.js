...
(function() {
    ...
    const onShare = async () => {
      const title = "Bombay: La Ciudad de los Sueños";
      const text = "Bombay es la ciudad que nunca deja de convertirse en sí misma — un lugar de ambición, color y contradicción extraordinarios." || title;
