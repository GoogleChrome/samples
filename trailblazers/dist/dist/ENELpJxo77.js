...
(function() {
    ...
    const onShare = async () => {
      const title = "Maldivas: Paraíso Sobre el Agua al Borde del Mundo";
      const text = "Las Maldivas son lo más parecido a desaparecer dentro de una postal que el mundo real permite." || title;
