...
(function() {
    ...
    const onShare = async () => {
      const title = "Lisboa: Ciudad de Siete Colinas y Luz Eterna";
      const text = "Lisboa es la ciudad de Europa Occidental que todavía tiene la calidad de un secreto — luminosa, melancólica y profundamente humana." || title;
