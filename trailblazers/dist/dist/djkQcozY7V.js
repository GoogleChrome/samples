...
(function() {
    ...
    const onShare = async () => {
      const title = "Ciudad de México: Cimientos Antiguos, Pulso Moderno";
      const text = "La Ciudad de México está construida sobre las ruinas de un imperio azteca y vibra con la energía de una de las ciudades más grandes del mundo." || title;
