...
(function() {
    ...
    const onShare = async () => {
      const title = "Mumbai: The City of Dreams";
      const text = "Mumbai is the city that never stops becoming itself — a place of extraordinary ambition, colour, and contradiction." || title;
