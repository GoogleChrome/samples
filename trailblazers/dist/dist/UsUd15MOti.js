...
(function() {
    ...
    const onShare = async () => {
      const title = "ペトラ：バラ色の都市の秘密";
      const text = "ペトラの赤い都市は古代世界の驚異です。ナバテア人によって砂岩の崖に直接彫られたこの考古学的驚異は、シークと呼ばれる狭い峡谷を歩くことで秘密を明らかにします。宝物庫に畏敬の念を抱き、修道院まで登ってパノラマビューを楽しみ、キャンドルの夜の魔法を。" || title;
