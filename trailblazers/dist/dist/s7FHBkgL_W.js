...
(function() {
    ...
    const onShare = async () => {
      const title = "Edimburgo: Castillo, Callejones y la Llamada de las Highlands";
      const text = "Edimburgo es la ciudad donde la arquitectura medieval, los fantasmas literarios y los paisajes salvajes de las Highlands confluyen en un único horizonte dramático." || title;
