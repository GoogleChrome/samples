...
(function() {
    ...
    const onShare = async () => {
      const title = "Bangkok: La Ciudad de los Templos Dorados";
      const text = "Bangkok se mueve a diez velocidades simultáneamente, y de algún modo todas ellas son la velocidad correcta." || title;
