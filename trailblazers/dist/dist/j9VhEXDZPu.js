...
(function() {
    ...
    const onShare = async () => {
      const title = "Bahía de Ha Long: Aguas Esmeraldas y Gigantes de Piedra Caliza";
      const text = "La Bahía de Ha Long parece un mito hecho físico — miles de islas de piedra caliza emergiendo de aguas verdes hasta donde alcanza la vista." || title;
