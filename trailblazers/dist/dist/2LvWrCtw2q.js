...
(function() {
    ...
    const onShare = async () => {
      const title = "Queenstown: La Capital de la Aventura del Hemisferio Sur";
      const text = "Queenstown es donde las montañas se encuentran con el lago y alguien decidió inventar el puenting — y no ha parado de acelerar desde entonces." || title;
