...
(function() {
    ...
    const onShare = async () => {
      const title = "Dubrovnik: Walking the Walls Above the Adriatic";
      const text = "The walls of Dubrovnik have defended this city for centuries — today they offer the finest walking circuit in Europe." || title;
