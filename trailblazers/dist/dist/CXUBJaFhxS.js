...
(function() {
    ...
    const onShare = async () => {
      const title = "Rio de Janeiro: City of Carnival Colours";
      const text = "Rio is a city that performs itself constantly — every hillside, beach, and sunset is a stage." || title;
