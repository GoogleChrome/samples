...
(function() {
    ...
    const onShare = async () => {
      const title = "Istanbul: The City Between Two Worlds";
      const text = "Istanbul is the only city on earth that stands on two continents — and it has been bridging worlds for three thousand years." || title;
