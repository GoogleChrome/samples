...
(function() {
    ...
    const onShare = async () => {
      const title = "Amalfi Coast: Winding Roads and Salty Air";
      const text = "Discover the vertical landscape of Amalfi, where colorful houses cling to the cliffs and the scent of lemons fills the salty air." || title;
