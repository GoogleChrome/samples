...
(function() {
    ...
    const onShare = async () => {
      const title = "Marrakech: Perdida en el Laberinto de la Medina";
      const text = "Perderse en los zocos de Marrakech no es un error — es el objetivo de todo el viaje." || title;
