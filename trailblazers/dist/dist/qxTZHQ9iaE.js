...
(function() {
    ...
    const onShare = async () => {
      const title = "Costa Amalfitana: Caminos Sinuosos y Aire Salado";
      const text = "Descubre el paisaje vertical de Amalfi, donde las casas coloridas se aferran a acantilados y limones perfuman el aire." || title;
