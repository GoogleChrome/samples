...
(function() {
    ...
    const onShare = async () => {
      const title = "Prague: The Fairy-Tale City";
      const text = "Prague looks as though it was drawn by someone who had only read about cities in storybooks — and somehow it is also completely real." || title;
