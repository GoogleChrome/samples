...
(function() {
    ...
    const onShare = async () => {
      const title = "Ciudad del Cabo: La Montaña de la Mesa desde Abajo y desde Arriba";
      const text = "Table Mountain domina una ciudad de contrastes dramáticos y belleza natural impresionante. Ciudad del Cabo ofrece desde playas salvajes hasta viñedos de clase mundial en el valle Constantia. Sube a la montaña para vistas panorámicas únicas de trescientos sesenta grados, visita pingüinos en Boulders Beach y explora Robben Island con historia viva." || title;
