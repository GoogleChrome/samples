...
(function() {
    ...
    const onShare = async () => {
      const title = "Berlín: A Través del Muro y Más Allá";
      const text = "Berlín lleva su historia a flor de piel, y ninguna ciudad en el mundo transforma su pasado en arte vivo como esta." || title;
