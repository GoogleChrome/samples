...
(function() {
    ...
    const onShare = async () => {
      const title = "Masái Mara: Testigo de la Gran Migración";
      const text = "Nada en el mundo natural te prepara para la escala y el drama de la Gran Migración a través del Masái Mara." || title;
