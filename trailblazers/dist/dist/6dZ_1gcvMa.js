...
(function() {
    ...
    const onShare = async () => {
      const title = "Ámsterdam: La Vida a lo Largo de los Canales";
      const text = "Ámsterdam fue ingeniada contra la naturaleza y a favor de la belleza — y cinco siglos después, sigue ganando en ambos frentes." || title;
