...
(function() {
    ...
    const onShare = async () => {
      const title = "Dubrovnik: Caminando las Murallas sobre el Adriático";
      const text = "Las murallas de Dubrovnik han defendido esta ciudad durante siglos — hoy ofrecen el mejor circuito a pie de Europa." || title;
