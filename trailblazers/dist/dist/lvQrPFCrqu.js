...
(function() {
    ...
    const onShare = async () => {
      const title = "New York: Navigating the Concrete Jungle";
      const text = "Navigate the concrete jungle of Manhattan. Experience the electric energy of Times Square, find tranquility in Central Park, and explore world-class art and culture at every corner of this vibrant city." || title;
