...
(function() {
    ...
    const onShare = async () => {
      const title = "Masai Mara: Witness to the Great Migration";
      const text = "Nothing in the natural world prepares you for the scale and drama of the Great Migration across the Masai Mara." || title;
