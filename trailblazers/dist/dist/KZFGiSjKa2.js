...
(function() {
    ...
    const onShare = async () => {
      const title = "ケープタウン：下から、そして上から眺めるテーブルマウンテン";
      const text = "テーブルマウンテンが、劇的なコントラストと自然の美しさを持つ都市を見下ろします。ケープタウンは、野生の海からコンスタンシアのブドウ園までを提供。山に登りパノラマビューを楽しみ、ボルダーズビーチでペンギンに会い、ロベン島の歴史を学びましょう。" || title;
