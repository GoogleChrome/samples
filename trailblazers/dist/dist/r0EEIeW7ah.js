...
(function() {
    ...
    const onShare = async () => {
      const title = "Buenos Aires: Noches de Tango y Grandeza Belle Époque";
      const text = "Buenos Aires es la ciudad que inventó la melancolía como forma de arte, la puso a música y luego bailó sobre ella hasta el amanecer." || title;
