...
(function() {
    ...
    const onShare = async () => {
      const title = "Edinburgh: Castle, Closes, and the Call of the Highlands";
      const text = "Edinburgh is the city where medieval architecture, literary ghosts, and wild Highland landscapes converge in one dramatic skyline." || title;
