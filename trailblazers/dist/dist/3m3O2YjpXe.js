...
(function() {
    ...
    const onShare = async () => {
      const title = "Sídney: Amanecer Sobre el Puerto";
      const text = "El puerto de Sídney al amanecer es uno de esos paisajes raros que te hacen entender por qué nadie quiere irse de allí." || title;
