...
(function() {
    ...
    const onShare = async () => {
      const title = "La Habana: Calles de Época e Historia Viva";
      const text = "La Habana es la única ciudad del mundo donde el pasado y el presente parecen habitar el mismo aliento." || title;
