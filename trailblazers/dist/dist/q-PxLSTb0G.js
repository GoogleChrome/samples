...
(function() {
    ...
    const onShare = async () => {
      const title = "Banff: Turquoise Waters and Mountain Peaks";
      const text = "Pristine turquoise lakes and towering peaks await in the heart of the Canadian Rockies." || title;
