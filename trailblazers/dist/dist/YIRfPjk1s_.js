...
(function() {
    ...
    const onShare = async () => {
      const title = "Petra: Secrets of the Rose Red City";
      const text = "The Rose-Red City of Petra is a wonder of the ancient world. Carved directly into vibrant sandstone cliffs by the Nabateans, this archaeological marvel reveals its secrets as you walk through the narrow Siq. Marvel at the Treasury, climb to the Monastery for panoramic views, and experience the magic of candlelit nights in a desert landscape that feels both alien and deeply human." || title;
