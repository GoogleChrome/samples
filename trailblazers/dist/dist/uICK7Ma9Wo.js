...
(function() {
    ...
    const onShare = async () => {
      const title = "Bangkok: City of Golden Temples";
      const text = "Bangkok moves at ten speeds simultaneously, and somehow every single one of them is the right speed." || title;
