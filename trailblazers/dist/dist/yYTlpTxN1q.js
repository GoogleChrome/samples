...
(function() {
    ...
    const onShare = async () => {
      const title = "Berlin: Through the Wall and Beyond";
      const text = "Berlin wears its history on its sleeve, and no city on earth transforms its past into living art quite like this one." || title;
