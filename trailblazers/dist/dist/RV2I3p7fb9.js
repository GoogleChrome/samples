...
(function() {
    ...
    const onShare = async () => {
      const title = "Sydney: Sunrise Over the Harbour";
      const text = "Sydney Harbour at first light is one of those rare sights that makes you understand why people never want to leave." || title;
