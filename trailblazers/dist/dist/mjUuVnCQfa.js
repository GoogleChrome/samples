...
(function() {
    ...
    const onShare = async () => {
      const title = "Tokio: Noches de Neón y Santuarios Ocultos";
      const text = "Luces de neón, calles bulliciosas y tradiciones milenarias chocan en Tokio. Desde el santuario Meiji hasta la sobrecarga visual de Shibuya, vive una ciudad que nunca duerme. Explora artesanos y arquitectura futurista. Es una metrópolis que mezcla lo viejo y lo nuevo perfectamente en cada esquina y rincón histórico." || title;
