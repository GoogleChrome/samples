...
export declare class Roles extends APIResource {
     ...
     * ```
     */
    list(query?: RoleListParams | null | undefined, options?: RequestOptions): PagePromise<RolesPage, Role>;
    /**
...
export declare namespace Roles {
    export { type Role as Role, type RoleDeleteResponse as RoleDeleteResponse, type RolesPage as RolesPage, type RoleCreateParams as RoleCreateParams, type RoleUpdateParams as RoleUpdateParams, type RoleListParams as RoleListParams, };
}
