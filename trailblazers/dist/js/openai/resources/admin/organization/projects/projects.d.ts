...
import { CertificateActivateParams, CertificateActivateResponse, CertificateActivateResponsesPage, CertificateDeactivateParams, CertificateDeactivateResponse, CertificateDeactivateResponsesPage, CertificateListParams, CertificateListResponse, CertificateListResponsesPage, Certificates } from "./certificates.js";
import * as RateLimitsAPI from "./rate-limits.js";
import { ProjectRateLimit, ProjectRateLimitsPage, RateLimitListRateLimitsParams, RateLimitUpdateRateLimitParams, RateLimits } from "./rate-limits.js";
import * as RolesAPI from "./roles.js";
import { RoleCreateParams, RoleDeleteParams, RoleDeleteResponse, RoleListParams, RoleUpdateParams, Roles } from "./roles.js";
import * as ServiceAccountsAPI from "./service-accounts.js";
import { ProjectServiceAccount, ProjectServiceAccountsPage, ServiceAccountCreateParams, ServiceAccountCreateResponse, ServiceAccountDeleteParams, ServiceAccountDeleteResponse, ServiceAccountListParams, ServiceAccountRetrieveParams, ServiceAccounts } from "./service-accounts.js";
import * as GroupsAPI from "./groups/groups.js";
import { GroupCreateParams, GroupDeleteParams, GroupDeleteResponse, GroupListParams, Groups, ProjectGroup, ProjectGroupsPage } from "./groups/groups.js";
import * as UsersAPI from "./users/users.js";
import { ProjectUser, ProjectUsersPage, UserCreateParams, UserDeleteParams, UserDeleteResponse, UserListParams, UserRetrieveParams, UserUpdateParams, Users } from "./users/users.js";
...
export declare namespace Projects {
    ...
    export { Groups as Groups, type ProjectGroup as ProjectGroup, type GroupDeleteResponse as GroupDeleteResponse, type ProjectGroupsPage as ProjectGroupsPage, type GroupCreateParams as GroupCreateParams, type GroupListParams as GroupListParams, type GroupDeleteParams as GroupDeleteParams, };
    export { Roles as Roles, type RoleDeleteResponse as RoleDeleteResponse, type RoleCreateParams as RoleCreateParams, type RoleUpdateParams as RoleUpdateParams, type RoleListParams as RoleListParams, type RoleDeleteParams as RoleDeleteParams, };
