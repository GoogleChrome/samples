...
import { RolesPage } from "../roles.mjs";
import { APIPromise } from "../../../../core/api-promise.mjs";
import { type NextCursorPageParams, PagePromise } from "../../../../core/pagination.mjs";
...
export declare class Roles extends APIResource {
     ...
     * ```
     */
    list(projectID: string, query?: RoleListParams | null | undefined, options?: RequestOptions): PagePromise<RolesPage, RolesAPI.Role>;
    /**
...
export declare namespace Roles {
    export { type RoleDeleteResponse as RoleDeleteResponse, type RoleCreateParams as RoleCreateParams, type RoleUpdateParams as RoleUpdateParams, type RoleListParams as RoleListParams, type RoleDeleteParams as RoleDeleteParams, };
}
